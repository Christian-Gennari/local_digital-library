    ...
    <div className="relative flex items-center space-x-4">
      ...
      <div className="flex-1 relative">
        ...
        <input
          ...
          placeholder="Search..."
          className="w-full pl-10 pr-10 py-2 border theme-border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
        {value && (
          <button
            onClick={() => onChange("")}
        ...
        <button
          ...
          className={`flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-all cursor-pointer ${
            isOpen || hasActiveFilters
              ? "view-toggle-active shadow-md" // or theme-btn-primary
              : "theme-btn-primary"
          }`}
        >
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="flex justify-between pt-2">
                ...
                <button
                  ...
                  className="text-xs px-3 py-1 theme-btn-primary rounded-full hover:bg-slate-700 cursor-pointer"
                >
                  Done
                </button>
              </div>
